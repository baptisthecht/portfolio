...
export default function ProjectCard({path, name, desc, link}) {
  ...
  return (
    <Link to={link} className={darkMode ? 'cardhoverdark flex flex-col items-start gap-[8px] rounded-[16px] p-[12px] pb-[16px] w-auto h-auto cursor-pointer' : 'cardhoverlight flex flex-col items-start gap-[8px] rounded-[16px] p-[12px] pb-[16px] w-auto h-auto cursor-pointer'}>
